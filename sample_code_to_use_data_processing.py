...
for i in [0, 4]:
    ...
    print("Now training LSTM Model with both enhancements for {}:".format(COURSE_NAMES[i]))
    ...
    print("Now training LSTM Model with tied embeddings for {}:".format(COURSE_NAMES[i]))
