...
for i in range(1):
    ...
    lstm_tied_embeddings = MOOC_LSTM_Model(old_embedding_size)
    lstm_tied_embeddings.create_lstm_model(lrate=0.01, layers=2, embed_dim=128, seq_len=sequence_max_len, \
        model_load_path=None, confidence_penalty_weight=0, use_tied_embedding=True)
    lstm_tied_embeddings.plot_model()
    '''
