...
train_proportion, val_proportion = 0.75, 0.1
...
lstm_model = MOOC_LSTM_Model(vocab_size, multihot_input=True)
lstm_model.create_lstm_model(lrate=0.001, layers=1, embed_dim=256, seq_len=sequence_len, \
    confidence_penalty_weight=1.0, use_tied_embedding=True, model_load_path=None)
lstm_model.early_stopping_fit(train_x, train_y, val_x, val_y, batch_size=128,\
...
transformer_model.create_basic_transformer_model(lrate=2e-4, layers=2, embed_dim=256, seq_len=sequence_len, \
