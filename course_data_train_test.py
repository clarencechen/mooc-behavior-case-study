...
lstm_confidence_penalty = MOOC_LSTM_Model(vocab_size, embed_dim=256, seq_len=sequence_len, layers=1, multihot_input=True, \
    lrate=0.001, confidence_penalty_weight=0.1, use_tied_embedding=True, model_load_path=None)
...
lstm_enhanced = MOOC_LSTM_Model(vocab_size, embed_dim=256, seq_len=sequence_len, layers=1, multihot_input=True, \
    lrate=0.001, confidence_penalty_weight=0.1, use_tied_embedding=True, model_load_path=None)
